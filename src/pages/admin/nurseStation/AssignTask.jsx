...
const AssignTask = () => {
  ...
  const getFilteredNurses = (shiftKey) => {
    ...
    return nurses.filter((nurse) => nurse.toLowerCase().includes(searchTerm));
  };
    ...
    try {
      ...
      for (const [shiftKey, shiftData] of Object.entries(shifts)) {
        ...
        for (let i = 0; i < validTasks.length; i++) {
          ...
          const { error } = await supabase.from("nurse_assign_task").insert([
            {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">
            Assign nursing tasks for different shifts
          </p>
        </div>
                            ...
                            <div className="absolute z-50 w-full mt-1 bg-white border border-gray-300 rounded-lg shadow-lg max-h-60 overflow-y-auto">
                              ...
                              <div className="py-1">
                                {getFilteredNurses(shiftKey).length > 0 ? (
                                  getFilteredNurses(shiftKey).map(
                                    (nurse, index) => (
                                      <div
                                        key={`${nurse}-${index}`}
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
                  {filteredBeds.map((bed, idx) => (
                    ...
                    >
                      ...
                      <h4 className="font-bold text-gray-800 text-center mb-1 text-lg">
                        Bed {bed.bedNo}
                      </h4>
                      <p className="text-sm text-center text-gray-600 font-medium mb-1 truncate">
                        {bed.patientName}
                      </p>
