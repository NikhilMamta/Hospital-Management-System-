...
const isRelevantRow = (row) =>
  row.category === "Radiology" && row.radiology_type === "X-ray";
...
// Completed X-Ray records (planned3 and actual3 set)
...
const XRay = () => {
  ...
  const loadData = async (silent = false) => {
    try {
      ...
      const [pendingData, historyNames] = await Promise.all([
        // Pending X-Ray records
        // Conditions: category = 'Radiology', radiology_type = 'X-ray', planned3 IS NOT NULL, actual3 IS NULL, payment_status = 'Yes'
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const {
        data: { publicUrl },
      } = supabase.storage.from("xray_reports").getPublicUrl(fileName);
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="hidden mt-0.5 text-xs text-gray-600 sm:block">
                Process X-Ray reports and manage records
              </p>
            </div>
            <button
                      ...
                      <tr>
                        ...
                        >
                          ...
                          <p className="text-lg font-medium text-gray-900">
                            No pending X-Ray records
                          </p>
                          <p className="text-sm text-gray-500 mt-1">
                            X-Ray records with payment status will appear here
                          </p>
                        </td>
                      </tr>
                    )}
                    ...
                    <div className="relative">
                      {viewingRecord.xrayReport
                        ...
                        <div className="relative group">
                          ...
                          <button
                            onClick={() =>
                              handleViewReport(viewingRecord.xrayReport)
                            }
